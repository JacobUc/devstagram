        ...
        <header class="p-5 bg-white shadow">
            <div class="container mx-auto flex justify-between items-center">
                <h1 class="text-3xl font-black">
                    ...
                    @auth
                        <nav class="flex gap-2 items-center">
                            <a href="{{ route('posts.create') }}" class="flex items-center gap-2 bg-white border border-gray-300 p-2 text-gray-600 rounded text-sm uppercase font-bold cursor-pointer">
